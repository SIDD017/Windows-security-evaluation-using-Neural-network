...
def gen_dataset():
    ...
    # Best case
    untrusted_apps = [0, 1]
    unsigned_drivers = [0, 3]
    pasword_length = [12, 16]
    password_duration = [0, 45]
    updates = [1, 2, 3, 4, 5]
    ...
    # Worst case
    untrusted_apps = [11, 12, 13]
    unsigned_drivers = [21, 22, 23]
    pasword_length = [0, 4]
    password_duration = [135, 180]
    updates = [0]
    ...
    for i in range(0, 150):
        ...
        engine.run()
        dataset_scores.append([engine.finalscore])
    return dataset_facts, dataset_scores
